      ...
      <div class="w-full sm:w-1/2 px-4">
        ...
        {/* <Image src='src\emoji.png' alt='Winner'
          ...
          <div class="flex justify-between bg-slate-400 bg-opacity-50 rounded-lg py-6 my-6 ">
            <p class="mr-4 mx-6 text-sm justify-start">You will receive<br/><span class="text-2xl text-blue-600 font-bold inline-flex">890,308
            ...
            <button class="bg-blue-600 hover:bg-slate-500 text-white font-bold py-2 px-4 rounded-lg mx-6 ">
            Claim
            </button>
          </div>
          ...
          <h1 class="pt-3 text-white">Excess $STC should be burned after claim </h1>
          <div class="flex justify-start items-center mb-3">
            ...
            <p id='demo'></p>
              ...
              <div class="flex justify-start items-center mb-3">
            <p class="mr-4 text-white">$STC for airdrop left: </p>
            <center>
